...
describe("nexmedis login test", function(){
    ...
    it("TC002 - Login dengan field ID Perusahaan kosong",async function () {
        ...
        await loginPage.assertEmptyId('Please fill your channel id','Error massage not displayed properly');
    })
    ...
    it("TC003 - Login dengan ID Perusahaan tidak valid",async function () {
        ...
        await loginPage.assertWrongId('ID Organisasi/Perusahaan tidak valid. Silahkan ulangi kembali.','Error massage not displayed properly');
    })
    ...
    it("TC004 - Login dengan field Email dan/atau Password kosong",async function () {
        ...
        await loginPage.assertEmptyLogin('Semua input field wajib diisi','Error massage not displayed properly');
    })
    ...
    it("TC005 - Login dengan Password tidak valid",async function () {
        ...
        await loginPage.assertWrongPassword('Invalid password.','Error massage not displayed properly');
    })
    ...
    it("TC006 - Login dengan Email tidak valid",async function () {
        ...
        await driver.sleep(2000);
        await loginPage.assertWrongEmail('Login Failed - The username or password you entered is incorrect.','Error massage not displayed properly');
    })
